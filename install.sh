...
function shortexec() {
    ...
    echo -e "⚙️ Creating shortcut KtotoServer on 
   $PREFIX/bin/\n"
...
echo -e "⚠️ On first boot run 'ktotoserver' to start service."
echo -e "⚠️ To check status web server run 'ktotoserver-check' 
